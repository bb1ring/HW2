...
all_info = bakers_df|>
  ...
  left_join(viewers_df, by = c("series", "episode"), relationship = "many-to-many") |>
...
write_csv(final_data, "HW2/final_dataset.csv")
...
star_bakers <- final_data %>%
  ...
  summarise(StarBaker = first(BakerName[Result == "Star Baker"]))
